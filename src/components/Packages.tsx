...
const homePackages = [
  {
    ...
    speed: "8 Mbps",
    price: "2,000",
    description: "Ideal for basic browsing and email",
    features: [
  ...
  },
  {
    ...
    speed: "50 Mbps",
    price: "3,000",
    description: "High performance for demanding users",
    features: [
      "4K streaming",
      "Online gaming",
  ...
  },
  {
    ...
    speed: "100 Mbps+",
    price: "4,000+",
    description: "Maximum speed, zero compromise",
    features: [
...
const businessPackages = [
  ...
  },
  {
    ...
    speed: "50 Mbps",
    price: "8,500",
    description: "Reliable connectivity for growing teams",
    features: [
      "Up to 25 devices",
      "Static IP address",
      "99.7% uptime SLA",
  ...
  },
  {
    ...
    speed: "100 Mbps",
    price: "15,000",
    description: "Dedicated performance for large organizations",
    features: [
      "Unlimited devices",
      "Dedicated bandwidth",
      "99.9% uptime SLA",
  ...
  },
  {
    ...
    speed: "200 Mbps+",
    price: "25,000+",
    description: "Maximum performance, custom SLA",
    features: [
      "Scalable bandwidth",
      "Multiple static IPs",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {(planType === "home" ? homePackages : businessPackages).map((pkg, index) => (
            <Card
              key={index}
              className={`relative bg-card transition-all duration-300 hover:-translate-y-1 animate-fade-in ${
                pkg.popular ? "border-primary border-2 shadow-[0_8px_30px_hsl(var(--primary)/0.15)]" : "border-border shadow-sm"
              }`}
