...
const projects = [
  {
    ...
    client: "Financial Services HQ",
    location: "Nairobi CBD",
    category: "Fiber Installation",
    description: "Complete 1Gbps fiber optic installation serving 500+ workstations with redundant connections and failover.",
    image: heroBg,
    year: "2024",
  ...
  },
  {
    ...
    client: "Major Retail Complex",
    location: "Nairobi",
    category: "CCTV & Security",
    description: "120+ 4K cameras with AI-powered analytics covering parking, corridors, and entry points with centralized monitoring.",
    image: cctvInstall,
    year: "2024",
  ...
  },
  {
    ...
    description: "Complete data center build-out with 50 server racks, redundant cooling, and 99.99% uptime infrastructure.",
    image: serverRoom,
    year: "2023",
  ...
  },
  {
    ...
    client: "Leading Healthcare Facility",
    location: "Nairobi",
    category: "Network Setup",
    description: "Structured cabling and network infrastructure for voice, data, and video across 8 floors with unified communications.",
  ...
  },
  {
    ...
    location: "Nairobi",
    category: "Fiber Installation",
    description: "FTTH deployment to 200 homes with dedicated fiber connections and smart home integration.",
    image: heroBg,
    year: "2023",
  ...
  },
  {
    ...
    category: "Software",
    description: "Custom ERP solution covering inventory, HR, and accounting with mobile app integration for field teams.",
    image: serverRoom,
    year: "2024",
  ...
  },
  {
    ...
    location: "Nairobi",
    category: "Network Setup",
    description: "Full campus network with enterprise WiFi, computer labs, and integrated learning management system.",
    image: heroTechnicians,
    year: "2023",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProjects.map((project, index) => (
            <Card
              key={index}
              className="bg-card border-border hover:border-primary/30 transition-all duration-300 overflow-hidden group animate-fade-in card-hover"
