    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="mailto:info@nosteq.co.ke" className="hover:text-primary transition-colors">info@nosteq.co.ke</a></li>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-sm text-muted-foreground">© {currentYear} Nosteq Networks Limited. All Rights Reserved.</div>
          <div className="flex gap-3">
            {[
              ...
              <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-accent hover:bg-primary/10 rounded-full flex items-center justify-center transition-all hover:scale-105 group" aria-label={social.label}>
                <social.icon className="w-4 h-4 text-muted-foreground group-hover:text-primary transition-colors" />
              </a>
            ))}
            <a href="https://www.tiktok.com/@nosteq.network.li" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-accent hover:bg-primary/10 rounded-full flex items-center justify-center transition-all hover:scale-105 group" aria-label="TikTok">
