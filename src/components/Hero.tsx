          ...
          <div className="text-center md:text-left space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-8 justify-center md:justify-start pt-6">
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-primary-foreground">99.9%</div>
                <div className="text-sm text-primary-foreground/50">Uptime SLA</div>
              </div>
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-primary-foreground">1Gbps</div>
                <div className="text-sm text-primary-foreground/50">Max Speed</div>
              </div>
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-primary-foreground">24/7</div>
                <div className="text-sm text-primary-foreground/50">Support</div>
              </div>
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-primary-foreground">5000+</div>
                <div className="text-sm text-primary-foreground/50">Clients Served</div>
              </div>
            </div>
          </div>
