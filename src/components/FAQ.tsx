...
const faqs = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: "We offer free standard installation for all new customers on 6-month contracts or longer. For month-to-month plans, a one-time installation fee of KES 3,000 applies. Business installations are quoted based on scope and complexity."
      },
      {
      ...
      },
      {
        ...
        answer: "We currently cover Nairobi, Kiambu, Thika, and surrounding areas with rapid expansion underway. Contact us with your location for the latest coverage information."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        answer: "Absolutely. You can change your package at any time. Upgrades take effect immediately, while downgrades apply at your next billing cycle. No penalties for switching."
      },
      {
        question: "What payment methods do you accept?",
        answer: "We accept M-Pesa, bank transfers, card payments, and Airtel Money. Business accounts can arrange invoiced billing with net-30 terms."
      },
      {
    ...
    questions: [
      {
        ...
        answer: "We guarantee 99.9% uptime for all packages. If uptime falls below this in any month, you receive pro-rated credit. Business plans include SLA-backed guarantees."
      },
      {
